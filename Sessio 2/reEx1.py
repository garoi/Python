...
f = open(sys.argv[1], 'rb') # obre l'arxiu
...
#posa el nom davant dels cognoms. Els cognoma acaben per ',' i el nom per 'Grup'
for l in lines:   # itera sobre les linies de l'arxiu
    s=re.sub(r'([^,]+), ([ \w]*)(?=Grup)',r'\2\1; ',l) #substitueix expressio
